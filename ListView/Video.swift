...
struct VideoList {
    static let topTwelve = [
        ...
        Video(imageName: "2018-setup", title: "iOS Developemnt Setup -  iMac Pro", uploadDate: "May 11 2018"),
        ...
        Video(imageName: "nav-controller", title: "15 iOS Developer Portfolios", uploadDate: "February 15, 2020")
